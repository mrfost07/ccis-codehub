...
import {
  ...
  Eye, ChevronRight, RefreshCw, Edit, Trash2, Play, X, Save, Upload
} from 'lucide-react'
...
function InstructorDashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      {/* Instructor Header */}
      <div className="bg-gradient-to-r from-purple-600 via-purple-700 to-indigo-800 px-4 sm:px-6 py-6 sm:py-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-2xl sm:text-3xl font-bold text-white flex items-center gap-2 sm:gap-3">
            <GraduationCap className="h-6 w-6 sm:h-8 sm:w-8" />
            Instructor Dashboard
          </h1>
          <p className="text-purple-100 mt-1 sm:mt-2 text-sm sm:text-base">Manage your courses and track student progress</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8 overflow-x-auto scrollbar-hide touch-scroll -mx-4 px-4 sm:mx-0 sm:px-0">
          <div className="flex gap-2 sm:gap-4 min-w-max sm:min-w-0 sm:flex-wrap">
            <button
              ...
              className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors text-sm sm:text-base whitespace-nowrap"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors text-sm sm:text-base whitespace-nowrap"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 bg-slate-800/50 backdrop-blur-sm hover:bg-slate-700 border border-slate-700/50 rounded-lg text-white transition-colors text-sm sm:text-base whitespace-nowrap"
            >
        ...
        {/* Tabs */}
        <div className="overflow-x-auto scrollbar-hide touch-scroll -mx-4 px-4 sm:mx-0 sm:px-0 mb-6 sm:mb-8">
          <div className="flex gap-1 border-b border-slate-800 min-w-max sm:min-w-0">
            {tabs.map((tab) => {
              const Icon = tab.icon
              return (
                <button
                  ...
                  className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2.5 sm:py-3 font-medium transition-colors text-sm sm:text-base whitespace-nowrap ${activeTab === tab.id
