    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 flex items-center justify-center p-4">
      <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-xl sm:rounded-2xl p-6 sm:p-8 w-full max-w-md">
        <div className="flex flex-col items-center justify-center mb-6 sm:mb-8">
          <img src="/logo/ccis-logo.svg" alt="CCIS CodeHub" className="h-16 w-16 sm:h-20 sm:w-20 mb-3 sm:mb-4" />
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2.5 sm:px-4 sm:py-3 text-sm sm:text-base bg-slate-800 border border-slate-700 rounded-lg focus:outline-none focus:border-indigo-500 transition"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 sm:py-3 text-sm sm:text-base bg-gradient-to-r from-indigo-600 to-pink-600 rounded-lg font-semibold hover:from-indigo-700 hover:to-pink-700 transition disabled:opacity-50 disabled:cursor-not-allowed active:scale-95"
          >
        ...
        <p className="text-center text-sm sm:text-base text-slate-400 mt-4 sm:mt-6">
        ...
        <div className="mt-4 sm:mt-6">
          <Link to="/" className="block text-center text-sm sm:text-base text-slate-400 hover:text-white transition">
            ← Back to Home
          </Link>
        </div>
      </div>
