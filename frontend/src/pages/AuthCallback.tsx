...
export default function AuthCallback() {
        ...
        return (
            <div className="min-h-screen bg-neutral-950 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-neutral-400">Please wait while we complete authentication</p>
                </div>
            </div>
        );
    }
    ...
    if (status === 'existing_user') {
        return (
            <div className="min-h-screen bg-neutral-950 flex items-center justify-center p-4">
                <div className="bg-neutral-900/50 backdrop-blur-sm border border-amber-500/50 rounded-xl p-8 max-w-md text-center">
                    ...
                    <p className="text-neutral-400 mb-2">An account with this email already exists:</p>
                    <p className="text-purple-400 font-medium mb-6">{existingEmail}</p>
                    <p className="text-neutral-400 mb-6">Please login instead to access your account.</p>
                    <div className="space-y-3">
                        ...
                        <Link
                            to="/"
                            className="block w-full py-3 bg-neutral-700 hover:bg-neutral-600 text-white rounded-lg font-semibold transition text-center"
                        >
                            Back to Home
                        </Link>
                    </div>
    ...
    if (status === 'error') {
        return (
            <div className="min-h-screen bg-neutral-950 flex items-center justify-center p-4">
                <div className="bg-neutral-900/50 backdrop-blur-sm border border-red-500/50 rounded-xl p-8 max-w-md text-center">
                    ...
                    <div className="space-y-3">
                        ...
                        <button
                            ...
                            className="w-full py-3 bg-neutral-700 hover:bg-neutral-600 text-white rounded-lg font-semibold transition"
                        >
                            Try Again
                        </button>
                    </div>
