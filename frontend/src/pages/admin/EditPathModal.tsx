                ...
                <form onSubmit={(e) => { e.preventDefault(); onSubmit(); }} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-neutral-300 mb-2">
                            ...
                            <span className="text-xs text-neutral-400 ml-2">- Awarded when all modules completed</span>
                        </label>
                        <input
                            type="file"
                        ...
                        {certificateFile && (
                            <p className="text-xs text-purple-400 mt-1">New file: {certificateFile.name}</p>
                        )}
                    </div>
