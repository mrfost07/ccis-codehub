...
export default function StudentLearningDashboard() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'paused': return 'bg-amber-600/20 text-amber-400'
  ...
  return (
    <div className="min-h-screen bg-neutral-950">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="rounded-xl border border-purple-500/20 bg-gradient-to-r from-purple-600/15 to-transparent p-6 mb-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <h3 className="text-2xl font-bold text-white mb-1">Ready to learn?</h3>
              <p className="text-neutral-400">Explore new career paths and expand your skills</p>
            </div>
            <button
              onClick={() => navigate('/learning')}
              className="px-5 py-2.5 bg-purple-600 hover:bg-purple-500 text-white rounded-lg font-semibold transition flex items-center gap-2 whitespace-nowrap"
            >
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex gap-2">
              <button className="px-4 py-2 bg-purple-600/20 text-purple-400 rounded-lg hover:bg-purple-600/30 transition">
                All
              </button>
              <button className="px-4 py-2 bg-neutral-700/50 text-neutral-400 rounded-lg hover:bg-neutral-700 transition">
                Active
              </button>
              <button className="px-4 py-2 bg-neutral-700/50 text-neutral-400 rounded-lg hover:bg-neutral-700 transition">
                Completed
          ...
          {enrollments.length === 0 ? (
            <div className="bg-neutral-800/50 backdrop-blur border border-neutral-700 rounded-xl p-12 text-center">
              ...
              <button
                onClick={() => navigate('/learning')}
                className="px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-lg font-semibold hover:from-purple-700 hover:to-purple-800 transition"
              >
                Browse Career Paths
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {enrollments.map((enrollment) => (
                <div
                  key={enrollment.id}
                  className="bg-neutral-800/50 backdrop-blur border border-neutral-700 rounded-xl p-6 hover:border-purple-600/50 transition-all shadow-lg hover:shadow-xl"
                >
                  {/* Header */}
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    {enrollment.career_path_details && (
                      <>
                        <div className="text-center p-2 bg-neutral-700/50 rounded">
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white rounded-lg font-semibold transition flex items-center justify-center gap-2 shadow-lg"
                  >
        ...
        {stats.completed_paths > 0 && (
          <div className="mt-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-neutral-800/50 backdrop-blur border border-neutral-700 rounded-xl p-4 text-center">
                ...
                <p className="text-neutral-400 text-sm">Complete your first module</p>
              </div>
              ...
              <div className="bg-neutral-800/50 backdrop-blur border border-neutral-700 rounded-xl p-4 text-center opacity-50">
                ...
                <p className="text-neutral-400 text-sm">7-day learning streak</p>
              </div>
              ...
              <div className="bg-neutral-800/50 backdrop-blur border border-neutral-700 rounded-xl p-4 text-center opacity-50">
                ...
                <p className="text-neutral-400 text-sm">Complete 5 career paths</p>
              </div>
              ...
              <div className="bg-neutral-800/50 backdrop-blur border border-neutral-700 rounded-xl p-4 text-center opacity-50">
                ...
                <p className="text-neutral-400 text-sm">Score 100% on 10 quizzes</p>
              </div>
            </div>
          </div>
        )}
