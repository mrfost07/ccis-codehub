        ...
        'questions': [
            {
                ...
                'choices': [
                               'Users can provision resources automatically, without the provider having to intervene',
        ...
        'questions': [
            ...
            },
            {
                ...
                'choices': [
                               ...
                               'Containers share the host operating system kernel instead of each carrying a full operating system',
                               'Containers each run a full operating system, while virtual machines share one',
