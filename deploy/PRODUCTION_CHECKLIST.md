...
| 3 | **`EMAIL_BACKEND` is the console backend in production** — no email is ever actually sent (password reset, verification, notifications all silently no-op). Configure SMTP. | 🟠 |
